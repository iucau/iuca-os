...
int main(int argc, char **argv)
{
    ...
    /*
        ...
        1. Check if the file system exists. If the file system exists,
           stop, and print an error message. Continue if the `has_force_option`
           is present.
        2. Call the appropriate file system function to initialize the
